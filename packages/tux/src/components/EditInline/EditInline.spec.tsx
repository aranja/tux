...
describeBoth((EditInline) => {
  it('should support empty value', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={model} field="missing" />
    )
    expect(result).toMatchSnapshot()
  })
  ...
  it('should support string fallback', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={model} field="missing">Foo</EditInline>
    )
  ...
  it('should support mixed fallback', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={model} field="missing">Hello <strong>world</strong></EditInline>
    )
  ...
  it('should render plain field from model', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={model} field="field">Hello world</EditInline>
    )
  ...
  it('should render plain field from html model', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={htmlModel} format="plain" field="field">Hello world</EditInline>
    )
  ...
  it('should render html field from html model', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={htmlModel} format="html" field="field">Hello world</EditInline>
    )
  ...
  it('should render html field from raw model', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={rawModel} format="html" field="field">Hello world</EditInline>
    )
    expect(result).toMatch('Model')
    expect(result).toMatch('<strong>value</strong>')
    expect(result).toMatchSnapshot()
  ...
  it('should render raw field from raw model', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={rawModel} format="raw" field="field">Hello world</EditInline>
    )
    expect(result).toMatch('Model')
    expect(result).toMatch('<strong>value</strong>')
    expect(result).toMatchSnapshot()
  ...
  it('should render raw field from html model', () => {
    const result = renderToStaticMarkup(
      <EditInline tux={new MockContext()} isEditing={false} model={htmlModel} format="raw" field="field">Hello world</EditInline>
    )
    expect(result).toMatch('Model')
    expect(result).toMatch('<strong>value</strong>')
    expect(result).toMatchSnapshot()
