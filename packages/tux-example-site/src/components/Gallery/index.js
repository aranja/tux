...
const defaultData = [
  { image: image1, title: 'Have some iced tea', copy: 'Persius laboramus pro in. Mutat harum nam ei. Eam in graeco offendit. Reque saepe nusquam qui ea, ad nonumy causae molestie nam. Alia vocibus invidunt in mea. Sit albucius conclusionemque ea, sea oblique posidonium. Lorem ipsum dolor sit amet.' },
  { image: image2, title: 'Hold your dog up high', copy: 'Molestiae ratione doloremque nam nostrum temporibus at harum ipsa consequuntur alias dolor. Facere ex ipsam vero ipsa possimus, accusamus debitis perspiciatis eius nam suscipit! Architecto nam tempora omnis quaerat incidunt minus laudantium exercitationem soluta impedit ducimus expedita ipsum cumque, voluptates quas ea.' },
  { image: image3, title: 'Evil buildings', copy: 'Accusamus modi perferendis iste, labore voluptates ut asperiores voluptatibus qui architecto, soluta. Dolore cumque maiores expedita dignissimos laborum, nemo beatae ipsa rem! Voluptates temporibus modi, quam enim sapiente iste ab quisquam minima nihil, ad officia ea omnis numquam consectetur. Vero architecto, neque!' }
]
