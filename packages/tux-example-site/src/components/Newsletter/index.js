...
const Newsletter = () =>
  <div className="Newsletter">
    <div className="Newsletter-register">
      <input
        type="text"
        className="Newsletter-registerInput"
    ...
    <div className="Newsletter-social">
      <p className="Newsletter-socialIcon">
        <span className="icon icon-twitter_circle" />
      </p>
      <p className="Newsletter-socialIcon">
        <span className="icon icon-facebook_circle" />
      </p>
      <p className="Newsletter-socialIcon">
        <span className="icon icon-git_circle" />
      </p>
    </div>
  </div>
